...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn("fixed inset-0 z-50 bg-background/60 backdrop-blur-[2px] animate-fade-in", className)}
    {...props}
  />
));
...
const sheetVariants = cva(
  "fixed z-50 gap-4 border-border bg-card p-0 shadow-xl transition ease-in-out focus-ring flex flex-col",
  {
    variants: {
      side: {
